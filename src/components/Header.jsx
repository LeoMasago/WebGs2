        ...
        <>
            <header>
                <div className="containerHeader">
                    ...
                    <button onClick={btnf} type="button" className="btnNav">
            ...
            <div id="menu" className="menuBar">
                <div className="menu">
                    ...
                    <a className="linksMenu">
                        ...
                        <NavLink to="/contato">Contato</NavLink></a>
                </div>
            </div>
